<%-- 
    Document   : add
    Created on : Feb 23, 2025, 4:57:30 PM
    Author     : LE VAN THUAN
--%>
        ...
        <div class="category-container">
            ...
            <div>
                <c:if test="${not empty requestScope.success}">
                    <p style="color: green; font-weight: bold;">${requestScope.success}</p>
                </c:if>
            ...
            <form action="${pageContext.request.contextPath}/admin/category/add-cate" method="post" class="category-form">
